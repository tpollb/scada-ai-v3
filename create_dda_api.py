#!/usr/bin/env python3
"""Создание api.py для deep_analysis"""

from pathlib import Path

api_content = '''"""Deep Analysis API endpoints"""
...
print("=" * 70)
print("✅ СОЗДАН ФАЙЛ: backend/modules/deep_analysis/api.py")
print("=" * 70)
print()
print("Endpoints:")
print("  POST   /deep_analysis/run              — запуск анализа")
print("  GET    /deep_analysis/tags             — список тегов")
print("  GET    /deep_analysis/history          — список анализов")
print("  GET    /deep_analysis/history/{id}     — загрузка анализа")
print("  DELETE /deep_analysis/history/{id}     — удаление анализа")
print("  GET    /deep_analysis/ping             — health check")
print()
print("Следующий шаг: регистрация роутера в backend/main.py")