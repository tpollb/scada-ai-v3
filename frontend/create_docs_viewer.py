...
print('=== create_docs_viewer.py ===')
print()

# ============================================================================
# 1. Устанавливаем marked
# ============================================================================
print('📦 Устанавливаем marked...')
result = subprocess.run(['npm', 'install', 'marked'], capture_output=True, text=True)
if result.returncode == 0:
    print('✓ marked установлен')
else:
...
# ============================================================================
# 2. Создаём src/components/DocsViewer.svelte
# ============================================================================
...
# ============================================================================
# 3. Патчим src/routes/Config.svelte
# ============================================================================
config_path = Path('src/routes/Config.svelte')
config = config_path.read_text(encoding='utf-8')

# 3.1. Добавляем импорт DocsViewer
...
# 3.3. Добавляем кнопку "Документация" в табы
old_tabs = '''      <button
        type="button"
...
# 3.4. Добавляем блок рендеринга docs после блока system
...
print('ЧТО СДЕЛАНО:')
print('=' * 60)
print('1. Установлен marked (npm install marked)')
print()
print('2. Создан src/components/DocsViewer.svelte:')
...
print()
print('3. Обновлён src/routes/Config.svelte:')
