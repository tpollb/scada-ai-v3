...
print('=== fix_llm_api.py ===')
print()

# Исправляем только modules/analytics/llm/analyzer.py
...
print('✓ modules/analytics/llm/analyzer.py: исправлена сигнатура вызова LLM')
print()
print('=' * 60)
print('ЧТО ИСПРАВЛЕНО:')
print('=' * 60)
print()
print('Сигнатура провайдера: provider.generate(system: str, user: str) -> str')
print()
print('Было (неправильно):')
print('  provider.generate(user_prompt, system_prompt=ANALYTICS_SYSTEM_PROMPT)')
print()
print('Стало (правильно):')
print('  provider.generate(ANALYTICS_SYSTEM_PROMPT, user_prompt)')
print()
print('Упрощён код:')
print('  • Убраны лишние варианты с kwargs')
print('  • Убраны fallback на generate_with_tools и complete')
print('  • Оставлен только правильный вызов generate(system, user)')
print()
...
print()
print('Если YandexGPT не настроен — вернётся fallback с полем llm_error')