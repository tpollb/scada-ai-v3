...
print('=== fix_impact_calculation.py ===')
print()

# ============================================================================
# Исправляем analyzers/aggregators.py
# ============================================================================
...
print('✓ analyzers/aggregators.py: исправлена формула расчёта impact')
...
print('=' * 60)
print()
print('1. Outlier rate (исправлена формула):')
print('   • Было: outliers / total_raw (могло быть >100%)')
print('   • Стало: outliers / (outliers + total_raw) (всегда 0-100%)')
print()
print('2. Trend penalty (усиленная логика):')
print('   • Учитывает days_to_critical (дни до критической границы)')
print('   • Усиливается если R² высокий (надёжный тренд)')
print('   • Умножается на 1.5 если критическая граница через <30 дней')
print('   • Базовый множитель: weight × 40 (было × 30)')
print()
print('3. Добавлено поле days_to_critical:')
print('   • Количество дней до достижения crit_min или crit_max')
print('   • null если тренд слабый или стабильный')
print()
print('4. Улучшен reason:')
print('   • "Rising +0.74/day (R²=0.59), reaches CRITICAL in 25 days"')
print()
...
print('  • Humidity должна быть #1 с severity=high')
print('  • VOC outlier_rate должен быть <100%')
print('  • В reason появится "reaches CRITICAL in N days"')